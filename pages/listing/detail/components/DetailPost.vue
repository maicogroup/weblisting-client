    ...
    <div class="mx-5">
      ...
      <div class="mt-3 flex flex-col md:flex-row md:justify-between">
        ...
        <div class="mt-2 md:mt-0 flex items-center space-x-2">
          <p class="leading-none color-3f3f3f text-sm">
            Chia sẻ qua:
          </p>
          <div
      ...
      <div class="lg:mx-0 w-full flex space-x-12 lg:w-5/6 bd-color-858585 mt-3 text-sm leading-4 border-t border-b border-zinc-800 pb-7 pt-6 border-solid">
        <div class="">
