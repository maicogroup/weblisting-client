<template>
  <div class="border-stone-200 border w-72 rounded-md px-6 py-4 flex flex-col items-center">
    ...
    <a href="tel:0938140024" class="mt-3 rounded-md w-56 h-10 border bg-green-600 hover:bg-green-700 text-white text-sm font-bold flex items-center justify-center">
    ...
    <button class="mt-2 text-sm text-green-600 rounded-md w-56 h-10 border border-green-600 text-sm font-bold hover:text-green-700 hover:border-green-700 hover:bg-gray-100" @click="featureNotSupported">
      Yêu cầu tư vấn
    </button>
  </div>
</template>
