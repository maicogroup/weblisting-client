<template>
	<div>
		<div class="lg:mx-0 mx-5 flex justify-between items-end">
			<h3 class="font-bold text-lg mt-8">Có thể bạn quan tâm</h3>
		...
		<div
			...
			class="mx-5 lg:mx-0 mt-3 no-scrollbar p-2 md:p-4 border flex space-x-3 md:space-x-6 overflow-auto"
		>
			<nuxt-link
				v-for="post in formatedPosts"
				:key="post.id"
				:to="`/chi-tiet-can-ho/${post.slug}`"
			>
				<div class="post border border-stone-200 rounded-md overflow-hidden">
					...
					<div class="mx-2 my-2">
						<div class="flex justify-between">
							...
							<div class="flex space-x-1">
								<div class="flex items-center">
									...
									>
										<path
											d="M5.83301 7.66663C7.21634 7.66663 8.33301 6.54996 8.33301 5.16663C8.33301 3.78329 7.21634 2.66663 5.83301 2.66663C4.44967 2.66663 3.33301 3.78329 3.33301 5.16663C3.33301 6.54996 4.44967 7.66663 5.83301 7.66663ZM5.83301 4.33329C6.29134 4.33329 6.66634 4.70829 6.66634 5.16663C6.66634 5.62496 6.29134 5.99996 5.83301 5.99996C5.37467 5.99996 4.99967 5.62496 4.99967 5.16663C4.99967 4.70829 5.37467 4.33329 5.83301 4.33329ZM15.833 1.83329H9.16634V8.49996H2.49967V0.166626H0.833008V12.6666H2.49967V10.1666H17.4997V12.6666H19.1663V5.16663C19.1663 3.32496 17.6747 1.83329 15.833 1.83329ZM17.4997 8.49996H10.833V3.49996H15.833C16.7497 3.49996 17.4997 4.24996 17.4997 5.16663V8.49996Z"
											fill="#858585"
										/>
									</svg>
						...
						<div
							class="mt-1 flex items-center justify-between text-neutral-400 text-xs"
						>
							<h4 class="truncate ...">
								{{ post.address }}
							</h4>
			...
			return this.posts.map(p => {
				return {
					srcimage:
						...
						(p.gallery.find(c => !c.includes(".mp4")) ||
					...
					acreage: p.acreage + "m²",
					address:
						p.project?.address.street +
						", " +
						p.project?.address.district +
						", " +
						p.project?.address.city,
