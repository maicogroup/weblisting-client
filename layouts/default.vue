<template>
	<div>
		<MainHeader />
		<div
			class="relative mt-20 md:mt-32 flex justify-center max-w-full min-h-screen"
		>
			<Nuxt />
		</div>
		<MainFooter />
		...
		<div class="md:hidden bg-white fixed bottom-0 w-full flex">
			<button
				class="shrink-0 w-1/3 min-w-min whitespace-nowrap px-8 py-4 bg-white text-sm text-green-600 font-bold"
			>
				Yêu cầu tư vấn
			</button>
			<a
				href="tel:0938140024"
				class="grow w-2/3 px-6 py-4 bg-green-600 hover:bg-green-700 text-white text-sm font-bold flex items-center justify-center"
			>
				<svg
