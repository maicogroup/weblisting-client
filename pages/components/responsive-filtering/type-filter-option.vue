	...
	<div>
		...
		>
			<div class="flex justify-between border-b rounded">
				...
				<p class="font-semibold px-6 py-2 mr-auto ml-auto">Chọn loại căn hộ</p>
			</div>
			<div
				class="flex justify-between h-11 border-b items-center mx-3"
				@click="handleSelectAllTypes"
			>
				<p class="text-dark-red">Tất cả nhà đất</p>
				<input type="radio" :checked="isSelected(null)" />
			</div>
			<div
				class="flex justify-between h-11 border-b items-center mx-3"
				@click="handleSelectType('Căn hộ chung cư')"
			>
				<p>Căn hộ chung cư</p>
			...
			<div
				class="flex justify-between h-11 border-b items-center mx-3"
				@click="handleSelectType('Officetel')"
			>
				<p>Officetel</p>
			...
			<div
				class="flex justify-between h-11 border-b items-center mx-3"
				@click="handleSelectType('Penthouse')"
			>
				<p>Penthouse</p>
			...
			<div
				class="flex justify-between h-11 border-b items-center mx-3"
				@click="handleSelectType('ShopHouse')"
			>
				<p>ShopHouse</p>
