<template>
  <div class="z-10 w-full fixed left-0 top-after-header hidden md:flex space-x-4 bg-white shadow-sm px-4">
    ...
    <div class="flex justify-between grow">
      ...
      <bedroom-filter-dropdown :selected-option="filter.bedroomOptions" @optionchanged="handleBedroomFilterChanged" />
    </div>
    ...
    <button class="whitespace-nowrap ml-12 rounded-md px-6 bg-green-600 hover:bg-green-700 font-semibold text-white my-4" @click="$emit('search')">
      Tìm kiếm
    </button>
  </div>
</template>
