<template>
	<ul
		class="items-center mx-auto flex justify-center mt-4 text-stone-900 bg-white"
	>
		<li>
			<a
				:class="`
		...
		<li
			...
			class="h-[40px] w-[40px] flex justify-center items-center bg-white border border-stone-200"
		>
			...
		</li>
