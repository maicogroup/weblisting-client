<template>
	<div class="w-full">
		...
		>
			...
			/>
			<div
				class="relative mx-auto h-full text-[32px] md:text-[60px] md:leading-[75px] flex flex-col items-center justify-center font-bold font-source-serif-pro"
			>
		...
		<div
			class="object-cover center relative flex flex-col items-center md:justify-center"
		>
			<div class="pt-2.5 md:pt-10 pb-8 px-[21px] overflow-hidden">
				...
				<div class="flex space-x-6">
					<div
						class="min-w-0 md:max-w-[745px] max-w-[370px]"
						v-if="!$apollo.queries.blogPagination.loading"
					>
						<div
							v-for="blog in blogs"
							:key="blog.id"
						...
						>
							<nuxt-link class="shrink-0" :to="'/blog/' + blog.slug">
								<img
									:src="blog.thumbnail"
									class="h-[220px] w-[370px] md:w-[180px] md:h-[160px] blog-card-image"
								/>
							</nuxt-link>
