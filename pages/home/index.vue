    ...
    >
      <div class>
        <img
          ...
          class="h-[111px] md:h-[157px] object-cover mx-auto"
        />
      ...
      <div class="relative w-full h-96 md:w-[1000px] md:h-[1000px] mx-4">
        ...
        >
          <svg
            ...
            viewBox="0 0 72 72"
          >
            <defs><path id="svgIDa" d="M58 25.833L12 27v-7l46 1.167z" /></defs>
            <path fill="#FCEA2B" d="M58 25.833L12 27v-7l46 1.167z" />
            <path fill="#FCEA2B" d="M28 59H18l2-46h6z" />
            <path fill="#D0CFCE" d="M40.5 37h19v4h-19z" />
            <g
              fill="none"
              stroke="#000"
              ...
              stroke-width="2"
            >
              <use xlink:href="#svgIDa" />
              <path
                d="M28 59H18l2-46h6zm-9-9h8m-8-9h8m-7.5-7h7m7.5-8v-5m8 5v-5m8 16V21m-9.5 16h19v4h-19z"
              />
              <use xlink:href="#svgIDa" />
            </g>
          </svg>
          ...
          <div class="w-[171px] md:w-[297px] text-center">
            ...
            <p class="text-[23px] md:text-[40px] font-bold">Đang hoàn thiện</p>
