<template>
    <div class="max-w-full">
            <div class="flex justify-between items-center mt-2 mb-2">
              ...
              <div>
                  ...
                  <Dropdown class="text-sm md:mr-9"> <DropdownItem>
                          Giá cao nhất
                      </DropdownItem>
                      <DropdownItem>
                          Giá thấp nhất
   ...
   <div class="flow-root">
        <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
            <li class="pb-6 md:pt-0 pt-6  md:border-none border-b border-black" v-for="post in posts" :key="post">
                <div class="">
...
export default { components: { Dropdown, DropdownItem }, name: 'ListPost', data(){
    return{
        posts : [{
