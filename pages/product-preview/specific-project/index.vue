<template>
	<div class="w-full max-w-screen-xl px-4">
		<div v-if="project != null" class="grid grid-cols-1 md:grid-cols-2 gap-4">
			<div>
				<img
					class="w-full h-60 object-cover lg:h-80"
						...
						<div class="flex items-start">
							...
							<div class="w-full ml-2 relative">
								<textarea
									...
									class="resize-none no-scrollbar w-full px-2 py-1 text-gray-800 border rounded-md focus:outline-none"
								/>
